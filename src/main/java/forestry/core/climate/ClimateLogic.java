...
public class ClimateLogic implements IClimateLogic, IStreamable {
	...
	public void update() {
		if (!active) {
			biomeState = ClimateRoot.getInstance().getBiomeState(getWorldObj(), getCoordinates());
	...
	public void readFromNBT(NBTTagCompound nbt) {
		currentState = ClimateManager.stateHelper.create(nbt);
		targetedState = ClimateManager.stateHelper.create(nbt.getCompoundTag("Target"));
